...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async (index) => {
    ...
    if (!experience.description?.trim()) {
      toast.error("You have to write some description before enhancing with AI.");
      return;
    }

    setGeneratingIndex(index)
    const prompt = `enhance this job description ${experience.description} for the position of ${experience.position} at ${experience.company}. Keep it 3-4 bullet points.`
