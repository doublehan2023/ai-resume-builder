      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            <UploadCloudIcon
              className="size-11 transition-all duration-300 p-2.5
            bg-gradient-to-r from-purple-300 to-purple-500 text-white rounded-full"
            />
            <p
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                text-slate-400 group-hover:text-slate-500 transition-all duration-300
                px-2 text-center"
        ...
        {showCreateResume && (
          ...
          bg-opcacity-50 z-10 flex items-center justify-center"
          >
            <div
              onClick={(e) => e.stopPropagation()}
